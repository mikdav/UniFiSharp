...
namespace UniFiSharp
{
    public partial class UniFiNetworkApi
    {
        ...
        public async Task<IEnumerable<MediaFile>> MediaFileList()
        {
            return await RestClient.UniFiGetMany<MediaFile>($"api/s/{Site}/rest/mediafile");
        }
        ...
        /// </summary>
        /// <returns>Collection of JSON objects describing media files stored on this controller</returns>
        public async Task<MediaFile> MediaFileGet(string fileId)
        {
            return await RestClient.UniFiGet<MediaFile>($"api/s/{Site}/rest/mediafile/{fileId}");
        }
        ...
        /// </summary>
        /// <returns>Collection of JSON objects describing sample media files stored on this controller</returns>
        public async Task<IEnumerable<SampleMedia>> SampleFileList()
        {
            return await RestClient.UniFiPostMany<SampleMedia>($"api/s/{Site}/cmd/streammgr/list-samples", new
            {
                cmd = "list-samples"
            });
        }
