...
namespace UniFiSharp
{
    public partial class UniFiNetworkApi
    {
        ...
        public async Task<IEnumerable<SystemHealth>> SiteHealthGet()
        {
            return await RestClient.UniFiGetMany<SystemHealth>($"api/s/{Site}/stat/health");
        }
        ...
        public async Task<PortForward> SitePortForwardsCreate(string name, string proto, string source, string dest, int fromPort, int toPort)
        {
            return await RestClient.UniFiPost<PortForward>($"api/s/{Site}/rest/portforward", new {
                name = name,
                proto = proto,
                dst_port = toPort,
                fwd_port = fromPort,
        ...
        public async Task<IList<PortForward>> SitePortForwardsList()
        {
            return await RestClient.UniFiGetMany<PortForward>($"api/s/{Site}/list/portforward");
        }
        ...
        public async Task<IList<RogueAp>> SiteRogueApList()
        {
            return await RestClient.UniFiGetMany<RogueAp>($"api/s/{Site}/stat/rogueap");
        }
        ...
        public async Task<UserGroup> SiteUserGroupsCreate(string name, int qosRateMaxDown = -1, int qosRateMaxUp = -1)
        {
            return await RestClient.UniFiPost<UserGroup>($"api/s/{Site}/rest/usergroup", new
            {
        ...
        public async Task<IEnumerable<UserGroup>> SiteUserGroupsList()
        {
            return await RestClient.UniFiGetMany<UserGroup>($"api/s/{Site}/list/usergroup");
        }
        ...
        public async Task<WlanGroup> SiteWlanGroupsCreate(string name, string radioType, int channelNa, int channelNg, bool pmfMode)
        {
            return await RestClient.UniFiPost<WlanGroup>($"api/s/{Site}/rest/wlangroup", new
            {
        ...
        public async Task<IEnumerable<WlanGroup>> SiteWlanGroupsList()
        {
            return await RestClient.UniFiGetMany<WlanGroup>($"api/s/{Site}/list/wlangroup");
        }
    }
}
